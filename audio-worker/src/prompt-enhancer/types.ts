 ...
 * 
 * Shared types and schemas for naming convention generation.
...
// Zod schema for naming-only responses from GPT
// Only classification metadata, no prompt modification
...
export type NamingOnlyResponse = z.infer<typeof NamingMetadataSchema>;

// Full metadata with resolved UCS category/subcategory and enhanced_prompt
export interface PromptMetadata extends NamingOnlyResponse {
    enhanced_prompt: string; // The prompt (original or enhanced via Edge Function)
